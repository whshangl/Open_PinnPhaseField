...
pinn_data = np.load('./PINN_data/pinn_P1P2_15.npy')
...
store_path = Path('./time_5plus10plus10/epoch_5plus10plus10')
...
# model.compile("L-BFGS", loss = 'MSE', loss_weights = loss_weights)
# model.restore(r"./time_5plus10plus10/epoch_5plus10plus10-60000.pt")
...
#     fem_data = np.loadtxt('./FEM_data/P1P2_25.txt', comments='%',delimiter=None)
...
#     plt.title("$P_1$ from FEM at t = 25", fontsize = 18)
...
#     #### vector
#     plt.savefig('./Figures/P1_time25_fem.pdf')


#     plt.title("$P_2$ from FEM at t = 25", fontsize = 18)
#     plt.xlabel("$x_1$ [nm]", fontsize = 18)
#     plt.ylabel("$x_2$ [nm]", fontsize = 18)
#     plt.xlim(-2,2)
#     plt.ylim(-2,2)
...
#     plt.quiver(xx[::4,::4], yy[::4,::4], P1_fem[::4,::4],  P2_fem[::4,::4], color = 'white')
#     ### vector
#     plt.savefig('./Figures/P2_time25_fem.pdf')


#     plt.title("$P_1$ from PINN at t = 25", fontsize = 18)
#     plt.xlabel("$x_1$ [nm]", fontsize = 18)
#     plt.ylabel("$x_2$ [nm]", fontsize = 18)
#     plt.xlim(-2,2)
#     plt.ylim(-2,2)
...
#     plt.savefig('./Figures/P1_time25_pinn.pdf')

#     plt.title("$P_2$ from PINN at t = 25", fontsize = 18)
#     plt.xlabel("$x_1$ [nm]", fontsize = 18)
#     plt.ylabel("$x_2$ [nm]", fontsize = 18)
#     plt.xlim(-2,2)
#     plt.ylim(-2,2)
...
#     plt.colorbar()
#     plt.quiver(xx[::4,::4], yy[::4,::4], P1_pinn[::4,::4], P2_pinn[::4,::4], color = 'white')
#     plt.savefig('./Figures/P2_time25_pinn.pdf')
    
    
#     plt.title("$|P_1^{pinn}-P_1^{fem}|$ at t = 25", fontsize = 18)
#     plt.xlabel("$x_1$ [nm]", fontsize = 18)
#     plt.ylabel("$x_2$ [nm]", fontsize = 18)
#     plt.xlim(-2,2)
#     plt.ylim(-2,2)
...
#     plt.colorbar()
#     plt.savefig('./Figures/P1_time_25_error.pdf')


#     plt.title("$|P_2^{pinn}-P_2^{fem}|$ at t = 25", fontsize = 18)
#     plt.xlabel("$x_1$ [nm]", fontsize = 18)
#     plt.ylabel("$x_2$ [nm]", fontsize = 18)
#     plt.xlim(-2,2)
#     plt.ylim(-2,2)
...
#     plt.colorbar()
#     plt.savefig('./Figures/P2_time25_error.pdf')
...
###############################################################################################
############################ store data of P1, P2 at (1,0), (0,1), (-1,0),(0,-1) between t = 15 and t = 25 ############################
###############################################################################################
...
#     pinn_P1P2_temporal[:,2] = xyt[:,2] + 15
#     pinn_P1P2_temporal[:,3] = P1_pinn
#     pinn_P1P2_temporal[:,4] = P2_pinn

#     np.save("./PINN_data/pinn_P1P2_15to25_" + str(xyt[0,0]) + "_" + str(xyt[0,1]) + ".npy",pinn_P1P2_temporal)
